...
| Cloudflare Workers AI | no-training | 2026-04-13 | [developers.cloudflare.com/workers-ai/privacy](https://developers.cloudflare.com/workers-ai/privacy/) |
| GitHub Models | no-training | 2026-04-13 | [docs.github.com GitHub Models](https://docs.github.com/en/github-models/responsible-use-of-github-models) |
...
Provider terms change. The gateway logs a warning at boot for any catalog entry older than 90 days so an operator can re-verify. The file that drives this is `apps/gateway/src/routing/privacy.ts` in the source tree. If a policy change is material enough to matter, open an issue and we will update both the source and this page in the same release.
